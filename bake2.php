...
<div class="container">
	<div class="inside">
        <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven2.png);"></button>
        <button onclick="self.location.href='bake2.php'" class="start" id="start">Start!!</button>
        <div class="count"><button class="count">count</button></div>
        <div class="material"><button class="material">material</button></div>
    </div>
</div>
<p>玩家名稱：<br/>
經驗值：<br/>
