...
<div class="container">
	<div class="inside">
        <div class="inside-img">
            <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven.png);"></button>
            <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven.png);"></button>
            <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven.png);"></button></br>
            <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven.png);"></button>
            <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven.png);"></button>
            <button onclick="self.location.href='bake2.php'" class="oven" id="oven" style="background-image:url(img/oven.png);"></button>
        </div>
